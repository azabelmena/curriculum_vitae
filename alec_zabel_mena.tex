...
\begin{rSection}{Memberships and Affiliations}
    ...
    Asociaci\'on de Estudiantes de Matem\'aticas (AeMAT) \hfill{2019-Present}
        \begin{itemize}
            \item Treasurer (2023-Present)
        \end{itemize}
    Consejo General de Estudiantes de Ciencias Naturales (CECN) {2023-Present}
        \begin{itemize}
            \item Graduate Representative for the Department of Mathematics
                (2022-2023)

            \item Representative to the Decanato de Estudios Graduados e
                Iinvestigaci\'on (DEGI)
                (2023-Present)
        \end{itemize}
    Senzala Capoeira \hfill{2016 - 2020, 2023-Present} \\
\end{rSection}
