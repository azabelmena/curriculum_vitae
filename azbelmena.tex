...
\begin{rSection}{Presentations and Talks}
    \begin{itemize}
        \item Zabel-Mena, Alec S., Janwa Heeralal, Agrinsoni, Carlos,
          (2025, March). Absolute Irreducibility of Generalized
          Trinomials Defined by APN Functions of the form
          $f(x)=x^i+h(x)$ over $\mathbb{F}_{2}^s$. [contributed talk].
          56\textsuperscript{th} Southeastern International Conference
          on Combinatorics, Graph Theory, and Computing. Boca Raton, FL.

        \item Zabel-Mena, Alec S., Janwa Heeralal, Agrinsoni, Carlos,
          (2025, March). Absolute Irreducibility of Generalized
          Trinomials Defined by APN Functions of the form
          $f(x)=x^i+h(x)$ over $\F_{2}^s$. [contributed talk].
          40\textsuperscript{th} Seminario Interuniversitario de Investicaci\'on en
          Ciencias Matem\'aticas (SIDIM). Ponce, PR.
...
\begin{rSection}{Memberships and Affiliations}
    ...
    %\hspace*{17mm} Treasurer \hfill{August 2025 -- May Present}   \\
